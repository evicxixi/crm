...
class Permission(models.Model):
    ...
    name = models.CharField(verbose_name='代码', max_length=64,
...
class UserInfo(models.Model):
    ...
    username = models.CharField(
        verbose_name='用户名', max_length=32, null=True, blank=True)
    password = models.CharField(
        verbose_name='密码', max_length=64, null=True, blank=True)
    email = models.CharField(
        verbose_name='邮箱', max_length=32, null=True, blank=True)
